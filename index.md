...
### Lab of Systems and Evolutionary RNA Biology
...
然而，除了已经注释的CDS之外，近期研究在基因组中发现很多其它类型的可以翻译的ORF，位于长链非编码RNA (long non-coding RNA, lncRNA)、mRNA的非编码区(untranslated region, UTR)、甚至CDS中（不同的阅读框），这些ORF我们统称为非经典ORF，即非经典翻译组。非经典ORF不仅在包括动物、植物在内的多种真核生物基因组中普遍存在，已有的研究证明其中一些ncORF翻译的产物(蛋白肽peptidein或蛋白质protein)在多种生命过程中行使重要功能。但是，除了少数非经典ORF，大多数非经典ORF的功能尚不清楚，非经典翻译组在不同物种间有什么差异以及如何演化等问题也缺乏系统的研究。我们致力于解析非经典翻译组的功能和演化规律，为相关的生命科学领域基础研究以及医学与遗传育种等领域的应用奠定基础。
